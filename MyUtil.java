...
// 다양한 방법들 중 한가지(그나마 쉬운 것을 골라서)이다.
...
public class MyUtil
{
	...
	public String pageIndexList(int currentPage, int totalPage, String listUrl)
	{
		...
		// (얼마만큼 이동해야 하는지)
		// ▶ 원래 6페이지에서 오른쪽으로 한 페이지 이동했을 때 위치가 16으로 만드는.
		
		// 페이징 처리가 별도로 필요하지 않은 경우 
		// 데이터가 존재하지 않거나,데이터의 수가
		// 1 페이지도 못 채우는 경우는 별도의 페이징 처리를 할 필요가 없다.
		if(currentPage==0)
			return "";
		...
		*/
		...
		// 만약 현재 페이지가 5 페이지고 (currentPage = 5)
		...
		// 『 20 / 10 = 2』 이며, 여기에 『* 10』 (10을 곱하면) 20이 되는데
